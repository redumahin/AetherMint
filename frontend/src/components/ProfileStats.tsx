          ...
          <div className="space-y-2">
            ...
            {showProgress && (
              <div className="flex gap-1">
                {Array.from({ length: Math.min(stats.studyStreak, 7) }).map((_, i) => (
                  <div
                    key={i}
                    className="flex-1 h-2 bg-orange-600 rounded-full"
                  />
                ))}
                {Array.from({ length: Math.max(0, 7 - stats.studyStreak) }).map((_, i) => (
                  <div
                    key={i}
        ...
        <div className="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/40 dark:to-purple-900/20 rounded-lg p-6 border border-purple-200 dark:border-purple-700">
          ...
          <div className="space-y-2">
            ...
            <div className="text-sm text-purple-600 dark:text-purple-400">
              {stats.rareAchievements} rare achievements
            </div>
            {showProgress && (
          ...
          <div className="space-y-2">
            ...
            {showProgress && (
              <div className="text-xs text-green-600 dark:text-green-400">
                Avg: {stats.averageCompletionTime} days/course
              </div>
            )}
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="text-center">
              ...
              <div className="text-3xl font-bold text-purple-700 dark:text-purple-300 mb-1">
                {Math.round((metrics.completionRate + metrics.achievementRate + (stats.percentile / 10)) / 3)}
              </div>
              <div className="text-sm text-purple-600 dark:text-purple-400">
                Performance Score
              </div>
